...
<template>
  <div id="system-menu-page" class="system-manage-page">
    <SearchForm ref="searchForm" :list="list" @update:list="updateList" :more-button="moreButton"
                :Initialize="Initialize" @search="onSearch"></SearchForm>
    <div class="list-wrap">
      ...
      <TableList ref="tableList" :showExpand="true" :key-list="keyList" :params="params" 	service="menu" :border="true"
                 api="menuList" :handle-data="handleData" heights="100%"></TableList>
    </div>
  </div>
</template>
